...
- (void)selectFirstItemInAllMenu {
    if (self.delegate || [self.delegate respondsToSelector:@selector(menu:didSelectRowAtIndexPath:)]) {
        NSInteger selectedMenuIndexCache = _currentSelectedMenudIndex;
        _currentSelectedMenudIndex = 0;
        [self confiMenuWithSelectRow:0];
        [self.delegate menu:self didSelectRowAtIndexPath:[DOPIndexPath indexPathWithCol:self.currentSelectedMenudIndex row:0]];
        _currentSelectedMenudIndex = selectedMenuIndexCache;
    } else {
