...
-(void)chushihua{
    ...
    _array1 = [NSArray arrayWithObjects:(id)[[UIColor yellowColor] CGColor],(id)[[UIColor redColor] CGColor], nil];
    _array2 = [NSArray arrayWithObjects:(id)[[UIColor yellowColor] CGColor],(id)[[UIColor greenColor] CGColor], nil];
...
-(void)setcanshu:(CGRect)rect{
    ...
    [_apath addArcWithCenter:_point radius:_bj startAngle:M_PI/2 endAngle:M_PI*2 clockwise:YES];
