...
- (void)initControlBtn {
    ...
    cancelBtn.backgroundColor = [UIColor colorWithRed:78.0/255.0 green:188.0/255.0 blue:211.0/255.0 alpha:1];//[UIColor blackColor];
    ...
    confirmBtn.backgroundColor = [UIColor colorWithRed:78.0/255.0 green:188.0/255.0 blue:211.0/255.0 alpha:1];//[UIColor blackColor];
